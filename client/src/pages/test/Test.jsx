    ...
    return (
        <div className="skyscraperTest">
            <div className='skyscraperTestW'>
                <div className="container  d-flex flex-wrap align-content-center" style={{"height":"85vh"}}>
                    <div className="row ">
                        <div className="col-md-4 mt-5" >
                            <Link to={'/test/level'} className="card englishCaerd" style={{ "borderRadius": "40px" }}>
                                <div className="card-body" style={{ height: 350 }}>
                                    <div className="cont">
                                        <div className="node widget-image widget css9 css126">
                                            <div className="bgnormal text-center">
                                                <img className="englishImg mt-3" alt="" src={TRAINER} />
                                            </div>
                        ...
                        <div className="col-lg-4 mt-5">
                            <Link to={"/test/english"} className="card englishCaerd" style={{ "borderRadius": "40px" }}>
                                <div className="card-body" style={{ height: 350 }}>
                                    <div className="cont">
                                        <div className="node widget-image widget css9 css126">
                                            <div className="bgnormal text-center">
                                            ...
                                            <h2 className="textable css128">тест технический английский</h2>
                                        </div>
                                        <div className="node widget-text cr-text widget css129">
                                            <p className="textable css130">Грамматика английского языка — это свод правил, по которым отдельные слова складываются в предложения.</p>
                                        </div>
                                    </div>
                                </div>
                            </Link>
                        ...
                        <div className="col-lg-4 mt-5">
                            <Link to={"/test/it_test"} className="card englishCaerd" style={{ "borderRadius": "40px" }}>
                                <div className="card-body" style={{ height: 350 }}>
                                    <div className="cont">
                                        <div className="node widget-image widget css9 css126">
                                            ...
                                            <h2 className="textable css128">Тесты для программистов по английскому языку</h2>
                                        </div>
                                        <div className="node widget-text cr-text widget css129">
